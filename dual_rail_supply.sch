...
<libraries>
<library name="murata-dc-dc-conv">
<packages>
<package name="MEJ2">
...
<pad name="VIN+" x="2.54" y="7.62" drill="0.7" diameter="1.778" shape="octagon"/>
<pad name="VIN-" x="5.08" y="7.62" drill="0.7" diameter="1.778" shape="octagon"/>
<pad name="VOUT-" x="12.7" y="7.62" drill="0.7" diameter="1.778" shape="octagon"/>
<pad name="GND" x="15.24" y="7.62" drill="0.7" diameter="1.778" shape="octagon"/>
<pad name="VOUT+" x="17.78" y="7.62" drill="0.7" diameter="1.778" shape="octagon"/>
</package>
</packages>
<symbols>
<symbol name="MEJ2D">
<description>The MEJ2 series are single and dual output
medically approved DC/DC converters in a 7 pin SIP
package style offering a power upgrade path from
the NMJ series SIP DC/DC converters. The MEJ2
series is UL 60950 and UL 60601 recognized, which
makes it ideal for applications where safety and
miniaturisation are of paramount importance.</description>
<pin name="VIN+" x="0" y="10.16" length="middle" rot="R180"/>
<pin name="VIN-" x="0" y="5.08" length="middle" rot="R180"/>
<pin name="VOUT+" x="25.4" y="12.7" length="middle"/>
<pin name="GND" x="25.4" y="7.62" length="middle"/>
<pin name="VOUT-" x="25.4" y="2.54" length="middle"/>
...
<text x="7.62" y="7.62" size="2.54" layer="94">MEJ2</text>
</symbol>
</symbols>
<devicesets>
<deviceset name="MEJ2D0512SC">
<description>Murata Power Solutions 2W Isolated DC-DC Converter, Vin 4.5 → 5.5 V dc, Vout ±12V, I/O isolation 5.2kV dc</description>
<gates>
<gate name="G$1" symbol="MEJ2D" x="0" y="0"/>
</gates>
<devices>
<device name="" package="MEJ2">
<connects>
...
<technologies>
<technology name="">
<attribute name="VIN" value="5" constant="no"/>
<attribute name="VOUT1" value="12" constant="no"/>
<attribute name="VOUT2" value="-12" constant="no"/>
</technology>
</technologies>
</device>
</devices>
...
<deviceset name="V_REG_337" prefix="U">
<description>&lt;b&gt;Voltage Regulator&lt;/b&gt;
Standard LM337 adjustable negative voltage regulator. AIO (Adjust Input Output). Google 'LM317 Calculator' for easy to use app to get the two resistor values needed. 240/720 for 5V output. 240/390 for 3.3V output.</description>
<gates>
<gate name="G$1" symbol="78ADJ-2" x="0" y="0"/>
</gates>
<devices>
...
<parts>
<part name="U$1" library="murata-dc-dc-conv" deviceset="MEJ2D0512SC" device=""/>
<part name="U1" library="SparkFun-PowerIC" deviceset="V_REG_317" device="SINK"/>
<part name="U2" library="SparkFun-PowerIC" deviceset="V_REG_337" device="SINK"/>
...
<instances>
<instance part="U$1" gate="G$1" x="15.24" y="53.34"/>
<instance part="U1" gate="G$1" x="86.36" y="71.12"/>
<instance part="U2" gate="G$1" x="86.36" y="35.56" rot="R180"/>
<instance part="SUPPLY1" gate="G$1" x="-5.08" y="50.8"/>
<instance part="SUPPLY2" gate="+5V" x="-5.08" y="68.58"/>
<instance part="J1" gate="G$1" x="-22.86" y="60.96" rot="MR180"/>
</instances>
<busses>
</busses>
<nets>
...
<wire x1="45.72" y1="55.88" x2="45.72" y2="35.56" width="0.1524" layer="91"/>
<wire x1="45.72" y1="35.56" x2="78.74" y2="35.56" width="0.1524" layer="91"/>
</segment>
</net>
<net name="+5V" class="0">
<segment>
